...
export const comparisonData: ComparisonRow[] = [
  ...
  { feature: 'Poplatek nákup ETF', degiro: '1 EUR (Core Selection), 3 EUR (ostatní ETF)', xtb: '0 % do 100 000 EUR/měs., pak 0,2 %', fio: '0,29-0,35% (CZ), 0,79% (EU)', trading212: '0% (bez limitu)', ibkr: '$0.005/akcii (min. $1)', portu: '0,24-1% ročně (dle částky)' },
