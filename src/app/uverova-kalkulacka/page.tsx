      ...
      <main className="max-w-6xl mx-auto px-4">
            ...
            <div className="md:flex md:items-center md:justify-between gap-8">
              <div className="max-w-xl">
                ...
                <div className="mt-5 flex flex-wrap gap-2.5">
                  ...
                  <Link href="/investicni-kalkulacka" className="rounded-lg border border-white/20 px-4 py-2 text-sm font-medium text-white hover:bg-white/10">Místo úvěru investovat?</Link>
                </div>
              </div>
        ...
        <section className="pb-10">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-5 md:p-6">
            ...
            <p className="mt-4">
              <Link href="/investicni-kalkulacka" className="inline-flex items-center gap-1 text-teal-700 hover:text-teal-800 font-medium text-sm">
        ...
        <section className="pb-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
            {([
              ...
              ['/srovnani', 'Srovnání ETF', ListChecks],
