    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 antialiased pb-16 md:pb-0">
      ...
      <main className="max-w-6xl mx-auto px-4">
        ...
        <nav className="py-3 text-xs text-slate-400 flex items-center gap-1.5">
          ...
          <span>/</span>
          <Link href="/kde-koupit" className="hover:text-slate-600">Kde koupit ETF</Link>
          <span>/</span>
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-5">
              ...
              <ul className="mt-3 space-y-2.5 text-sm text-slate-600">
                <li className="flex items-start gap-2">
                  ...
                  <span>Chcete frakční investování malých částek → <Link href="/recenze/trading212" className="text-teal-700 hover:underline">Trading 212</Link> nebo <Link href="/recenze/xtb" className="text-teal-700 hover:underline">XTB</Link></span>
                </li>
                <li className="flex items-start gap-2">
                  <X className="w-4 h-4 text-red-500 mt-0.5 shrink-0" />
                  <span>Potřebujete českou podporu 24/7 → <Link href="/recenze/xtb" className="text-teal-700 hover:underline">XTB</Link></span>
                </li>
                <li className="flex items-start gap-2">
                  <X className="w-4 h-4 text-red-500 mt-0.5 shrink-0" />
                  <span>Investujete do CZ dividendových akcií (kvůli 35% srážce) → <Link href="/recenze/fio" className="text-teal-700 hover:underline">Fio e-Broker</Link> (15 %)</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="pb-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
            {([
              ...
              ['/recenze/xtb', 'Recenze XTB', BadgeCheck],
              ['/recenze/fio', 'Recenze Fio e-Broker', BadgeCheck],
              ['/recenze/trading212', 'Recenze Trading 212', BadgeCheck],
              ['/recenze/ibkr', 'Recenze Interactive Brokers', BadgeCheck],
              ['/recenze/portu', 'Recenze Portu', BadgeCheck],
              ['/zebricky', 'Nejlepší ETF (co koupit)', TrendingUp],
              ['/pruvodce', 'Jak začít investovat', BookOpen],
