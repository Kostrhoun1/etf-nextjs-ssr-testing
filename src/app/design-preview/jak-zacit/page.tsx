            ...
            <div className="md:flex md:items-center md:justify-between gap-8">
              <div className="max-w-xl">
                ...
                <div className="mt-5 flex flex-wrap gap-2.5">
                  ...
                  <Link href="/co-jsou-etf" className="rounded-lg border border-white/20 px-4 py-2 text-sm font-medium text-white hover:bg-white/10">Co je ETF?</Link>
                </div>
              </div>
              ...
              <div className="mt-6 md:mt-0 md:w-72 shrink-0 rounded-xl bg-white/5 border border-white/10 p-5">
                ...
                <Link href="/co-jsou-etf" className="mt-3 inline-flex items-center gap-1.5 text-sm font-medium text-teal-300 hover:text-teal-200">
        ...
        <GuideSection id="kroky">
          ...
          <div className="mt-4">
            <GuideCallout icon={Calculator} title="Chcete vidět, kam vás pravidelné investování dovede?">
              ...
              <Link href="/kalkulacky/investicni-kalkulacka" className="text-teal-700 hover:underline font-medium">
