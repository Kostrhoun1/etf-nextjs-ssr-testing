...
export const metadata: Metadata = {
  title: 'iShares Core S&P 500 ETF (CSP1) — detail fondu, výnos v Kč | ETF průvodce',
  description:
    'Detail fondu iShares Core S&P 500 UCITS ETF (ISIN IE00B5BMR087): TER 0,07 %, výnos přepočtený do korun, složení, rizika a kde koupit. Pro české investory.',
          ...
          <div className="rounded-2xl bg-slate-900 text-white px-5 py-6 md:px-9 md:py-8">
            <div className="md:flex md:items-start md:justify-between gap-8">
              ...
              <div className="mt-5 md:mt-0 md:w-64 shrink-0">
                <Link href="/kde-koupit-etf" className="flex items-center justify-center gap-2 rounded-lg bg-teal-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-teal-500 w-full">
                  Kde koupit tento fond <ArrowRight className="w-4 h-4" />
                </Link>
                <Link href="/srovnani-etf" className="mt-2.5 flex items-center justify-center gap-2 rounded-lg border border-white/20 px-4 py-2.5 text-sm font-medium text-white hover:bg-white/10 w-full">
