...
export default function KurzovyDopadPreview() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Kalkulačka kurzového dopadu', item: 'https://etfpruvodce.cz/kalkulacky/kurzovy-dopad' },
    ],
  };
      ...
      <main className="max-w-6xl mx-auto px-4">
            ...
            <div className="md:flex md:items-center md:justify-between gap-8">
              <div className="max-w-xl">
                ...
                <div className="mt-5 flex flex-wrap gap-2.5">
                  ...
                  <Link href="/srovnani-etf" className="rounded-lg border border-white/20 px-4 py-2 text-sm font-medium text-white hover:bg-white/10">Najít vhodný ETF</Link>
                </div>
              </div>
        ...
        <section className="pb-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
            {([
              ['/kalkulacky/investicni-kalkulacka', 'Investiční kalkulačka', PiggyBank],
              ['/kalkulacky/kalkulacka-poplatku-etf', 'Kalkulačka poplatků', Scale],
              ['/srovnani-etf', 'Srovnání ETF', TrendingUp],
