  ...
  const steps: {
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Boxes, text: <>Chcete hotový recept? Mrkněte na <Link href="/portfolio-strategie" className="text-teal-700 hover:underline font-medium">modelová portfolia</Link> (např. permanentní nebo akciové).</> },
      ],
    },
    {
      n: '4',
      ...
      <main className="max-w-6xl mx-auto px-4">
            ...
            <div className="md:flex md:items-center md:justify-between gap-8">
              <div className="max-w-xl">
                ...
                <div className="mt-5 flex flex-wrap gap-2.5">
                  ...
                  <Link href="/pruvodce" className="rounded-lg border border-white/20 px-4 py-2 text-sm font-medium text-white hover:bg-white/10">Co je ETF?</Link>
                </div>
              </div>
              ...
              <div className="mt-6 md:mt-0 md:w-72 shrink-0 rounded-xl bg-white/5 border border-white/10 p-5">
                ...
                <Link href="/pruvodce" className="mt-3 inline-flex items-center gap-1.5 text-sm font-medium text-teal-300 hover:text-teal-200">
        ...
        <GuideSection id="kroky">
          ...
          <div className="mt-5 grid sm:grid-cols-3 gap-2.5">
            {([
              ['/srovnani', 'Srovnat ETF', Search],
              ['/zebricky', 'Žebříčky fondů', ListChecks],
              ['/srovnani-brokeru', 'Srovnání brokerů', Building2],
          ...
          <div className="mt-4">
            <GuideCallout icon={Calculator} title="Chcete vidět, kam vás pravidelné investování dovede?">
              ...
              <Link href="/investicni-kalkulacka" className="text-teal-700 hover:underline font-medium">
        ...
        <GuideSection id="dal">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
            {([
              ['/pruvodce', 'Co jsou ETF (základ)', BookOpen],
              ['/portfolio-strategie', 'Modelová portfolia', Boxes],
              ['/srovnani', 'Srovnání ETF', Search],
              ['/zebricky', 'Nejlepší ETF', ListChecks],
              ['/etf', 'Ukázka detailu fondu', Globe],
