  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 antialiased">
      ...
      <main className="max-w-6xl mx-auto px-4">
            ...
            <div className="md:flex md:items-center md:justify-between gap-8">
              <div className="max-w-xl">
                ...
                <div className="mt-5 flex flex-wrap gap-2.5">
                  ...
                  <Link href="/srovnani" className="rounded-lg border border-white/20 px-4 py-2 text-sm font-medium text-white hover:bg-white/10">Najít levný ETF</Link>
                </div>
              </div>
        ...
        {/* POPLATKY BROKERŮ */}
        <section className="pb-10">
          <SectionHead title="Poplatky brokerů" desc="Navazující náklad – kde ETF nakoupíte za nejméně." href="/kde-koupit" hrefLabel="srovnání brokerů" />
        ...
        <section className="pb-10">
          <SectionHead title="Nejlevnější ETF" desc="Reálně seřazené podle TER vzestupně z naší databáze – už víte, že poplatek bolí, tady jsou ty nejlevnější." href="/srovnani" hrefLabel="srovnat vše" />
