...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'article',
      url: 'https://etfpruvodce.cz/nejlepsi-etf/nejlepsi-spotrebni-etf',
    ...
    alternates: {
      canonical: 'https://etfpruvodce.cz/nejlepsi-etf/nejlepsi-spotrebni-etf'
    }
  };
}

export default function NejlepsiSpotrebniETFPage() {
  const currentYear = new Date().getFullYear();
  ...
  const articleSchema = {
    ...
    "image": "https://etfpruvodce.cz/og-consumer-etf.jpg",
    "author": {
      "@type": "Organization",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://etfpruvodce.cz/nejlepsi-etf/nejlepsi-spotrebni-etf"
    },
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://etfpruvodce.cz/nejlepsi-etf/nejlepsi-spotrebni-etf"
      }
    ]
  };
