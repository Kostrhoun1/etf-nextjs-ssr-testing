...
export default async function NouzovaRezervaPreview() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Kalkulačka nouzové rezervy', item: 'https://www.etfpruvodce.cz/kalkulacky/nouzova-rezerva' },
    ],
  };
            ...
            <div className="md:flex md:items-center md:justify-between gap-8">
              <div className="max-w-xl">
                ...
                <div className="mt-5 flex flex-wrap gap-2.5">
                  ...
                  <Link href="/kalkulacky" className="rounded-lg border border-white/20 px-4 py-2 text-sm font-medium text-white hover:bg-white/10">Další kalkulačky</Link>
                </div>
              </div>
        ...
        <section className="pb-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
            {([
              ...
              ['/zebricky', 'Žebříčky ETF', TrendingUp],
