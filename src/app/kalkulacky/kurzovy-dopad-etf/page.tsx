...
export const metadata: Metadata = {
  title: 'Kalkulačka kurzového dopadu ETF 2026 | Měnové riziko ETF',
  ...
  keywords: 'kalkulačka kurzový dopad ETF, měnové riziko ETF, CSPX hedging, EUR hedged ETF, USD CZK kurz, currency hedging kalkulačka 2026',
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Kalkulačka kurzového dopadu ETF 2026'
      }
    ]
  }
};
