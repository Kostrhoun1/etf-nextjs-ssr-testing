...
export const metadata: Metadata = {
  title: 'Investiční kalkulačka 2026 - Pravidelné investování',
  description: '✅ Bezplatná investiční kalkulačka pro pravidelné investování. Spočítejte si výnosy z měsíčního investování do ETF fondů. Včetně daní, inflace a složeného úročení. Zdarma 2026.',
  keywords: 'investiční kalkulačka, pravidelné investování, měsíční investice, složené úročení, výpočet výnosů, ETF kalkulačka 2026, složené úročení',
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Investiční kalkulačka 2026 - Pravidelné investování'
      }
    ]
  }
};
