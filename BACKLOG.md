...
## Teď (P0–P1)
- [ ] **Screener /srovnani – výkon na mobilu (Lighthouse Perf 46, LCP 5,9s, FCP 4,5s)**: flagship načítá všech 4867 fondů klientsky → těžký payload + hydratace. Zvážit: virtualizace seznamu, deferovat enrichment (useDeferredValue), menší initial payload / lazy zbytek, nebo server-side první stránka. Filtrování musí zůstat přes VŠECHNY fondy.
